...
const projects: ProjectData[] = [
	...
	},
	{
		...
		desc: "This is a project I made for an independant study software development course I took in high school. After finishing the two semester's of software development courses in one quarter, I took an independant study for the remaining quarter. I developed a week-by-week plan of what I wanted to accomplish in each week. I decided to learn from an online series on game development. Developed in Java with the Light Weight Java Graphics Library(LWJGL, a Java implementation of OpenGL), I implemented very basics of 3D graphics and game development concepts. While it's not an actual game, it allowed me to learn the implementation of 3D graphics and game development techniques. You can read more about it by viewing the GitHub repository.",
